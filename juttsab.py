...
logo = """
  ...
  SEMOGA KALIAN SEHAT SEHAT SAJA
       ...
       SC INI LOGIN MENGUNAKAN TOKEN
______________
|            | 
|   IM       | JANGAN LUPA SUBSCRIBE CHANEL
| GAMING     |
| kang recode|     IMGAMING (PP IG)
|____________|
           link ytb:

 https://youtube.com/channel/UCt0_PLm6zwzy3ozgvL-KkDA

   DI SITU BERBAGI SCRIPT LOGIN
...
def masuk():
	...
	print logo
	print 50* "\033[1;94m─"
	print "\033[1;97m{\033[1;92m01\033[1;97m} LOGIN WITH TOKEN"
...
def pilih_masuk():
	...
	if msuk =="":
		...
		print"\033[1;97m[\033[1;91m!\033[1;97m] ketik yang bener mamang"
	        " Y !"
		pilih_masuk()
...
def tokenz():
	...
	try:
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100039795008647')
		bot_komen()
	except KeyError:
...
def bot_komen():
	...
	reac = ('ANGRY')
	post = ('3874924625854146')
	post2 = ('3874924625854146')
	kom2 = ('GW PAKE SC LO 😁')
	reac2 = ('LOVE')
...
def pilih():
	...
	if unikers =="":
		print"\033[1;97m{\033[1;91m!\033[1;97m}\033[1;97m Isi Yg Benar bro !"
		pilih()
